...
def detect_face_and_crop(detector, image, score_thres=0.7, ratio_thres=1.5):
...
def process(args):
    ...
    for dirname in os.listdir(args.src_dir):
        ...
        if args.remove_dir_number:
            dirname = "".join(dirname.split("_")[1:])
        ...
        for path in tqdm(image_paths):
            ...
            image_cropped = detect_face_and_crop(detector,
                                                 image,
